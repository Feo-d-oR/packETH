                                        ...
                                        gpointer         user_data)
{
    ...
    //    index = g_list_index (GTK_MENU_SHELL, gtk_menu_get_children(menu), menu_item);
	switch (index) {
		case 1: {
                                        ...
                                        gpointer         user_data)
{
    ...
    if ( gtk_toggle_button_get_active(GTK_TOGGLE_BUTTON(ipv4_rdbt)) == 0) {
                                        ...
                                        gpointer         user_data)
{
    ...
    switch( active_index ) {
        case 0 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "0800");
            break;
        }
        case 1 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "86DD");
            break;
        }
        case 2 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "0806");
            break;
        }
        default : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "");
            gtk_editable_set_editable(GTK_EDITABLE(option_value), TRUE);
            break;
        }
    }
}
                                        ...
                                        gpointer         user_data)
{
    ...
    switch( active_index ) {
        case 0 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "0");
            break;
        }
        case 1 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "1");
            break;
        }
        case 2 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "2");
            break;
        }
        case 3 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "6");
            break;
        }
        case 4 : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "17");
            break;
        }
        default : {
            gtk_entry_set_text(GTK_ENTRY(option_value), "");
                                        ...
                                        gpointer         user_data)
{
    ...
    switch( active_index ) {
        case 0 : {
            gtk_entry_set_text(option_value, "00");
            gtk_notebook_set_current_page(notebook, 0);
            break;
        }
        case 1 : {
            gtk_entry_set_text(option_value, "03");
            gtk_notebook_set_current_page(notebook, 2);
            break;
        }
        case 2 : {
            gtk_entry_set_text(option_value, "08");
                                        ...
                                        gpointer         user_data)
{
        ...
        switch( active_index ) {
            case 0 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "00");
                break;
            }
            case 1 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "01");
                break;
            }
            case 2 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "02");
                break;
            }
            case 3 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "03");
                break;
            }
            case 4 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "04");
                break;
            }
            case 5 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "05");
                break;
            }
            case 6 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "06");
                break;
            }
            case 7 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "07");
                break;
            }
            case 8 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "08");
                break;
            }
            case 9 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "09");
                break;
            }
            case 10 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "10");
                break;
            }
            case 11 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "11");
                break;
            }
            case 12 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "12");
                break;
            }
            case 13 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "13");
                break;
            }
            case 14 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "14");
                break;
            }
            case 15 : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "15");
                break;
            }
            default : {
                gtk_entry_set_text(GTK_ENTRY(option_value), "");
	...
	ptr = buff;
        while (pif->if_index) {
                       snprintf(ptr, 100, "%s", pif->if_name);
                        ...
                        gtk_combo_box_text_append_text(GTK_COMBO_BOX_TEXT(combo), iftext);
...
/*
    gtk_combo_box_set_popdown_strings(GTK_COMBO_BOX(combo), glist) ;

    gtk_combo_box_append_text((GTK_COMBO_BOX(combo), iftext);
*/
                                        ...
                                        gpointer         user_data)
{
        ...
        switch (index) {
            case 0 : {
                gtk_entry_set_text(value, "11");
                gtk_notebook_set_current_page(target, 0);
                break;
            }
            case 1 : {
                gtk_entry_set_text(value, "11");
                gtk_notebook_set_current_page(target, 1);
                break;
            }
            case 2 : {
                gtk_entry_set_text(value, "12");
                gtk_notebook_set_current_page(target, 0);
                break;
            }
            case 3 : {
                gtk_entry_set_text(value, "16");
                gtk_notebook_set_current_page(target, 0);
                break;
            }
            case 4 : {
                gtk_entry_set_text(value, "22");
                gtk_notebook_set_current_page(target, 2);
                break;
            }
            case 5 : {
                gtk_entry_set_text(value, "17");
                gtk_notebook_set_current_page(target, 0);
                break;
            }
            default : {
                ...
                gtk_notebook_set_current_page(target, 0);
                gtk_editable_set_editable(GTK_EDITABLE(value), TRUE);
            }
        }
}
...
static GtkWidget *en1, *en2, *en3, *hb1, *hb2, *cb1;
static GtkWidget *rb1, *rb2, *rb3, *rb4, *rb5, *rb6, *rb7, *rb8, *rb9;
static void
lookup_widgets                        (GtkButton *button)
{
                                        ...
                                        gpointer         user_data)
{
        ...
        switch (index) {
            case 0 : {
                gtk_entry_set_text(value, "8");
                break;
            }
            case 1 : {
                gtk_entry_set_text(value, "0");
                break;
            }
            case 2 : {
                gtk_entry_set_text(value, "4");
                break;
            }
            case 3 : {
                gtk_entry_set_text(value, "18");
                break;
            }
            default : {
                gtk_entry_set_text(value, "");
